                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input value="<?= set_value('nama'); ?>" type="text" name="nama" class="form-control" id="nama" placeholder="Nama">
                                <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="nim">NIM</label>
                                <input value="<?= set_value('nim'); ?>" type="text" name="nim" class="form-control" id="nim" placeholder="NIM">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= set_value('asal_sekolah'); ?>" name="asal_sekolah" class="form-control" id="asal_sekolah" placeholder="asal_sekolah">
                                <?= form_error('asal_sekolah', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="no_hp">no_hp</label>
                                <input type="text" value="<?= set_value('no_hp'); ?>" name="no_hp" class="form-control" id="no_hp" placeholder="no_hp">
                            ...
                            <!-- <a href="<?= base_url('index.php/Mahasiswa/upload') ?>" class="btn btn-danger">Tambah</a> -->
                        </form>
                    </div>
                </div>
            </div>
